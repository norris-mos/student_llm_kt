...
Item = namedtuple('Item',['questionId','question_embedding','process_embedding','quizId','isCorrect','time','answer_value','correct_answer','process'])
...
class DataFrame2InteractionDictionary():
    def __init__(self, answers, questions, misconceptions, question_subject, train_split=0.8, random_seed=42):
        ...
        self.merge = answers.merge(questions, on='QuestionId', how='left').dropna().reset_index(drop=True)
    ...
    def createedi(self,max_seq_len,include_fields=None):
